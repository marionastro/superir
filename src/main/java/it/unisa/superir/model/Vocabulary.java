...
/**
 *This class rappresent a set of words of a file.
 * 
 * @author Gruppo5
 */
public class Vocabulary {
    ...
    /**
     *Costructor given a stream of strings (words).
    ...
    /**
     *Costructor given a collection of strings (words).
    ...
    /**
     *Costructor given a series of strings (words).
     * 
     ...
     * @return              a vocabulary that contains all the istances words plus the param ones.
     */
     ...
     * @param vocabulary    the vocabulary with words to fitler out.
     * @return              a vocabulary that contains the istance words excpet the param ones.
     */
